...
BOT_TOKEN = environ.get('BOT_TOKEN', '5528278955:AAHZ11ANxAqHeqVwF8e9Js7tR_ciuJg8yic')
...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>𝐑𝐄𝐐𝐔𝐄𝐒𝐓 𝐌𝐎𝐕𝐈𝐄 ➢ {title} </b>\n<i><b>𝐀𝐕𝐀𝐈𝐋𝐀𝐁𝐋𝐄 𝐋𝐀𝐔𝐍𝐆𝐔𝐀𝐆 ➢ {languages} </i></b>\n<i><b>𝐑𝐄𝐐𝐔𝐄𝐒𝐓 𝐆𝐑𝐎𝐔𝐏 ➢ {message.chat.title} </i></b>\n<i><b>𝐑𝐄𝐐𝐔𝐄𝐒𝐓 𝐏𝐄𝐑𝐒𝐎𝐍 ➢ {message.from_user.mention}\n</i></b>\n©️@jnaneshgowdatn")
